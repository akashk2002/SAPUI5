		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assignment 5",
									"targetURL": "#comyashassignment5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyashassignment5-display": {
								"semanticObject": "comyashassignment5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yash.assignment5",
									"url": sap.ui.require.toUrl("com/yash/assignment5")
								}
							}
						}
					}
