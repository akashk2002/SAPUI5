		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assignment7",
									"targetURL": "#comyashassignment7-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyashassignment7-display": {
								"semanticObject": "comyashassignment7",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yash.assignment7",
									"url": sap.ui.require.toUrl("com/yash/assignment7")
								}
							}
						}
					}
