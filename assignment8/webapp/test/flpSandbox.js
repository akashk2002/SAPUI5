		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assignment8",
									"targetURL": "#comyashassignment8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyashassignment8-display": {
								"semanticObject": "comyashassignment8",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yash.assignment8",
									"url": sap.ui.require.toUrl("com/yash/assignment8")
								}
							}
						}
					}
